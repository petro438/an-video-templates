...
export const SCHEMAS = [
  ...
  {
    id: "BigNumber-AN",
    name: "T3: Big Number (AN)",
    icon: "🔢",
    desc: "Big Number with the Action Network design palette",
    dur: 150,
    fields: [
      { k: "number", l: "Number", t: "text", ph: "67.5", d: "42" },
      { k: "suffix", l: "Suffix", t: "text", ph: "% or -1", d: "%" },
  ...
  {
    id: "Scoreboard-AN",
    name: "T7: Scoreboard (AN)",
    icon: "🏒",
    desc: "Scoreboard with the Action Network design palette",
    dur: 150,
    fields: [
      { k: "teamA.name", l: "Team A", t: "text", d: "USA" },
      { k: "teamA.score", l: "A Score", t: "number", d: 0 },
